...
def annotate(path):
    ...
    try:
        ...
        predictions_wic, predictions_wsd = model.predict(sentence_pairs)
    ...
    return jsonify(sentence_pairs=sentence_pairs, predictions_wic=predictions_wic, predictions_wsd=predictions_wsd)
